//
//  main.cpp
//  EA_Controller with Different Robot
//
...
//        robot.springs[ind].L0 = robot.all_cubes[0].springs[i].original_L0 + 0.1f*sin(5*T+0.75);
////        robot.springs[ind].L0 = 0.5 + 0.1f*sin(0.5f*T+1);
////        robot.springs[i].L0 = robot.springs[i].original_L0 + 0.2f*sin(0.5*T+1);
//    }
    for (int i=0; i<11; i++){
...
void initialize_robot(Robot &robot){
    ...
    for (int i=0; i<11; i++){
        ...
        if (i==0){
            ...
            if (i<5){
                //TODO: Need to build on the right face of the cube; starts with cube 0
                ...
                join_cubes(all_cubes[2], cube, 2, i, masses, springs, 1, 3, cube);
            }
            else if (i==6){
                //TODO: Need to build on the front face of the cube; starts with building on cube 2 front face
                ...
                join_cubes(all_cubes.back(), cube, all_cubes.size()-1, i, masses, springs, 2, 4, cube);
            }
            else if (i>=9 && i<11){
                //TODO: Go back to cube 3 and build on its right face
                if (i == 9){
                    join_cubes(all_cubes[6], cube, 6, i, masses, springs, 4, 2, cube);
                }
                else{
                    join_cubes(all_cubes.back(), cube, all_cubes.size()-1, i, masses, springs, 4, 2, cube);
                }
