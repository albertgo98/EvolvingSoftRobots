...
const double b = 0.9999; //damping (optional) Note: no damping means your cube will bounce forever
...
vector<float> const_k = {1000, 5000, 10000};
vector<float> const_a = {0, 0.05, 0.1, 0.2};
vector<float> const_w = {1.0, 3.0, 5.0};
vector<float> const_c = {0, 1, M_PI};
...
void mutate(Controller &offspring){
    vector<int> legs = {0, 1, 2, 6, 7, 8, 12, 13, 14, 17, 18, 19};
