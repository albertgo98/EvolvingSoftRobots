...
float determine_fitness(Controller &control, Robot robot){
    ...
    displacement = sqrt(pow(control.end[0]-control.start[0], 2) + pow(control.end[1]-control.start[1], 2))-sqrt(pow(control.end[2]-control.start[2], 2));
